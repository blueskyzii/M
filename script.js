...
const correctPassword =
  "0100110101000001010110010100000100100000010011010100100101010010010000010100111001000100010000010010000001010011010000010101001001001001";
...
function checkPassword() {
  ...
  if (inputBinary === correctPassword) {
    ...
    slider.style.backgroundColor = ["rgb(30, 30, 30)", "#b8b4a0"].includes(
      slider.style.backgroundColor
    )
      ? "#1e1e1e"
      : "#b8b4a0";
    icon.className = document.getElementById("darkModeToggle").checked
      ? "fas fa-eye"
      : "fas fa-eye-slash";
    sudahLogin = true;
...
function buttonDarkMode() {
  if (!sudahLogin) {
    ...
    slider.style.backgroundColor = ["rgb(30, 30, 30)", "#1e1e1e"].includes(
      slider.style.backgroundColor
    )
      ? "#b8b4a0"
      : "#1e1e1e";
